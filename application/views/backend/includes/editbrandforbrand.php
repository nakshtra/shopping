...
//print_r($brandcategory);
			...
			<div class="panel-body">
			  <form class="form-horizontal tasi-form" method="post" action="<?php echo site_url('site/editbrandforbrandsubmit');?>" enctype= "multipart/form-data">
            ...
            //alert($('#m".$i."').is(':checked'));
             ...
             $( '#m".$i."' ).click(function() {
				...
				<div class=" form-group">
				  ...
				  <div class="col-sm-4">
					<input type="file" id="normal-field" class="form-control" name="logo" value="<?php echo set_value('logo',$before['brand']->logo);?>">
					<?php if($before['brand']->logo == "")
						 { }
						 else
						 { ?>
							<img src="<?php echo base_url('uploads')."/".$before['brand']->logo; ?>" width="140px" height="140px">
						<?php }
					?>
				  </div>
				</div>
