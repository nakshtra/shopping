                ...
                <div class="col-sm-4">
                  <?php 
                        ...
                        foreach($store as $key=>$store){
                             if(in_array($key,$selectedstore)) 
                             {
                                 echo "<tr><td><input type='checkbox' name='storeid[]' id='select52' class='check' checked value='$key' >$store</td></tr>";          
                             }
                            else
                            {
                                echo "<tr><td><input type='checkbox' name='storeid[]' id='select52' class='check'  value='$key' >$store</td></tr>";          
                            }
                            
                        }

                        echo "</table>";
//echo form_dropdown('storeid[]', $store, $selectedstore,' class="form-control populate placeholder "');
								//echo form_dropdown('storeid',$store,'',);
