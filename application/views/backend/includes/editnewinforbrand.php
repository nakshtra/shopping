	    <section class="panel">
			...
			<div class="panel-body">
			  <form class="form-horizontal tasi-form" method="post" action="<?php echo site_url('site/editnewinforbrandsubmit');?>" enctype= "multipart/form-data">
...
//								echo form_dropdown('brand',$brand,set_value('brand',$before->brandid),'id="select2" onChange="changestore()" class="form-control populate placeholder select2-offscreen" , disabled="disabled"');
				...
				<div class=" form-group">
				  ...
				  <a href="<?php echo site_url('site/viewnewinforbrand'); ?>" class="btn btn-secondary">Cancel</a>
				</div>
				</div>
			  </form>
			  <script>
