                ...
                <form class="form-horizontal row-fluid" method="post" action="<?php echo site_url('site/editoffersubmit');?>" enctype="multipart/form-data">
                    ...
                    <div id="store" class="form-group">
                        ...
                        <div class="col-sm-5">
                            ...
                            <tr>
                                <td>
                                    <input type='checkbox' name='storeid[]' id='select51' class='check' checked value='$row->id'></td><td>$row->store</td><td>$row->storeaddress</td><td>$row->locationname</td><td>$row->mallname</td><td>$row->malladdress</td>
                            </tr>"; } else { echo "
                            <tr>
                                <td>
                                    <input type='checkbox' name='storeid[]' id='select51' class='check' value='$row->id'></td><td>$row->store</td><td>$row->storeaddress</td><td>$row->locationname</td><td>$row->mallname</td><td>$row->malladdress</td>
